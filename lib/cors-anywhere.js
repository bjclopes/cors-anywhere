...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    originWhitelist: ['https://api.genius.com', 'https://genius.com', 'https://i.imgur.com', 'https://api.spotify.com'],            // If non-empty, requests not from an origin in this list will be blocked.
